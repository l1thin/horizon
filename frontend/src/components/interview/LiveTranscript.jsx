...
export default function LiveTranscript({ transcript, interim }) {
  ...
  return (
    <div style={{ marginTop: '2rem', maxWidth: '600px', textAlign: 'center', minHeight: '60px' }}>
      <p style={{ color: '#fff', fontSize: '18px', margin: 0, lineHeight: '1.5' }}>{transcript}</p>
      <p style={{ color: '#8f93a2', fontSize: '18px', fontStyle: 'italic', margin: 0, lineHeight: '1.5' }}>{interim}</p>
    </div>
  );
}
